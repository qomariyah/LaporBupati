        ...
        <ul class="x-navigation">
            ...
            <li class="xn-openable <?= @$Aduan ?>">
                ...
                <ul>
                    ...
                    <li class="<?= @$aduan_diverifikasi ?>"><a href="<?= site_url('sysadmin/aduan/diverifikasi')?>"><span class="fa fa-check-square-o"></span> Diverivikasi<span class="pull-right badge badge-danger"><?= $diverifikasi ?></span></a></li>
