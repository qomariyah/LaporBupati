...
<html lang="en">
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
            <?php $this->load->view('view_opd/sidebar') ?>
            <!-- END PAGE SIDEBAR -->
            ...
            <!-- PAGE CONTENT -->
             <div class="page-content">
                ...
                <?php $this->load->view('view_opd/nav_vertical'); ?>
                ...
                <div class="page-content-wrap">
                    ...
                    <?php
                        if($content == 'dashboard'){
                            $this->load->view('view_opd/dashboard');
                            ...
                            $this->load->view('view_opd/elfinder');
                            ...
                            $this->load->view('view_opd/setting');
        ...
        <!-- MESSAGE BOX-->
        <?php $this->load->view('view_opd/messagebox'); ?>
        <!-- END MESSAGE BOX-->
