                        ...
                        <div class="timeline-item timeline-item-right">
                            ...
                            <div class="timeline-item-content">
                                ...
                                <div class="timeline-footer">
                                    <a href="<?= site_url('sysbupati/aduan/detail/'.$data->id_aduan) ?>">Selengkapnya...</a>
                ...
                <?php foreach($data_aduan as $key){ ?>
                    <div class="panel-heading">
                        <div class="pull-left">
                            ...
                            <h3 class="panel-title"><a href="<?= site_url('sysbupati/user/detail/').$key->id_user ?>"><?= p($key->nama_user) ?></a> <small><?= time_ago($key->tanggal) ?></small></h3>
                        </div>
                        <div class="pull-right">
                            <?php 
                                if ($key->status == "masuk") {
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?= site_url('sysbupati/aduan/verifikasi/'.p($key->id_aduan).'/detail')?>">Verifikasi</a></li>
                                    <li>
                                ...
                                <div class="modal" id="edit<?= p($key->id_aduan) ?>" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="<?= site_url('sysbupati/aduan/edit') ?>">
                                                    <div class="form-group">                                     
                                                        <div class="form-group">
                    ...
                    <div class="panel-body">
                                            ...
                                            <div class="message-box message-box-danger animated fadeIn" data-sound="alert" id="mb<?= p($komen->id_komentar) ?>">
                                                <div class="mb-container">
                                                    <div class="mb-middle">
                                                        ...
                                                        <div class="mb-footer">
                                                            <div class="pull-right">
                                                                <form action="<?= site_url('sysbupati/komentar/delete') ?>" method="POST">
                                ...
                                <div class="modal" id="edit<?= p($komen->id_komentar) ?>" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="<?= site_url('sysbupati/komentar/update') ?>">
                                                    <div class="form-group">                                     
                                                        <div class="form-group">
                        ...
                        <form method="POST" action="<?= site_url('sysbupati/komentar/tambah') ?>">
