					...
					<table class="table datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="<?= site_url('lbadmin/editsektor/'.$row->id_sektor.'/'.$row->sektor) ?>" class="btn btn-xs btn-rounded btn-info" data-toggle="tooltip" data-placement="top" title="Tekan untuk mengedit data">Edit</a>
							        ...
							        <div class="message-box message-box-danger animated fadeIn" data-sound="alert" id="mb-deladmin">
							            <div class="mb-container">
							                <div class="mb-middle">
							                    ...
							                    <div class="mb-footer">
							                        <div class="pull-right">
							                            <a href="<?= site_url('lbadmin/delete_sektor/'.$row->id_sektor.'/'.$row->sektor) ?>" class="btn btn-danger btn-lg">Ya</a>
							                            <button class="btn btn-info btn-lg mb-control-close">Tidak</button>
							                        </div>
							                    </div>
							                </div>
