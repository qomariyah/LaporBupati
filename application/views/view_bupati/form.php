	...
	<div class="row">
        <div class="col-md-12">
            <div class="panel panel-warning">
				...
				<div class="panel-body">
					<form enctype="multipart/form-data" method="POST" action="<?= site_url('lbadmin/update_admin') ?>">
...
<?php if ($content == 'tambah-sektor') { ?>
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<form class="form-horizontal" method="POST" action="<?= site_url('lbadmin/create_sektor') ?>">
...
<?php if ($content == 'edit-sektor') { ?>
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			...
			<form class="form-horizontal" method="POST" action="<?= site_url('lbadmin/update_sektor') ?>">
                <div class="panel panel-colorful">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?= $breadcrumb ?></h3>
                    </div>
